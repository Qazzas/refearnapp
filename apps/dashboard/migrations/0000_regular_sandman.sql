...
CREATE TABLE "license_keys" (
	...
	CONSTRAINT "license_keys_polar_id_unique" UNIQUE("polar_id")
);
--> statement-breakpoint
...
ALTER TABLE "referrals" ADD CONSTRAINT "referrals_referral_link_id_affiliate_link_id_fk" FOREIGN KEY ("referral_link_id") REFERENCES "public"."affiliate_link"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "subscription" ADD CONSTRAINT "subscription_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "subscription_expiration" ADD CONSTRAINT "subscription_expiration_promotion_code_id_promotion_codes_id_fk" FOREIGN KEY ("promotion_code_id") REFERENCES "public"."promotion_codes"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "discord_account_discord_user_idx" ON "discord_account" USING btree ("discord_user_id");--> statement-breakpoint
...
CREATE INDEX "referrals_email_link_idx" ON "referrals" USING btree ("signup_email","referral_link_id");--> statement-breakpoint
